 ...
 * @generated
 */
public class ErrorTest extends EventDefinitionTest {
	 ...
	 */
	@Override
	protected bpmn.Error getFixture() {
		return (bpmn.Error)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(BpmnFactory.eINSTANCE.createError());
	}
