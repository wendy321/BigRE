...
public class SubProcessItemProvider extends ActivityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubProcess_isCollapsed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubProcess_isCollapsed_feature", "_UI_SubProcess_type"),
				 BpmnPackage.Literals.SUB_PROCESS__IS_COLLAPSED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BpmnPackage.Literals.SUB_PROCESS__CHILDREN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.SUB_PROCESS__CHILDREN,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == BpmnPackage.Literals.SUB_PROCESS__CHILDREN;
