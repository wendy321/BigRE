 ...
 *   <li>{@link bpmn.impl.BusinessConceptsImpl#getContribTypeToParents <em>Contrib Type To Parents</em>}</li>
 *   <li>{@link bpmn.impl.BusinessConceptsImpl#getTopicChild <em>Topic Child</em>}</li>
 *   <li>{@link bpmn.impl.BusinessConceptsImpl#getTopic <em>Topic</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BusinessConceptsImpl extends MinimalEObjectImpl.Container implements BusinessConcepts {
	...
	public EList<Contribution> getContribTypeToParents() {
		if (contribTypeToParents == null) {
			contribTypeToParents = new EObjectContainmentEList<Contribution>(Contribution.class, this, BpmnPackage.BUSINESS_CONCEPTS__CONTRIB_TYPE_TO_PARENTS);
		}
	...
	public EList<GraphcialObject> getTopicChild() {
		if (topicChild == null) {
			topicChild = new EObjectWithInverseResolvingEList.ManyInverse<GraphcialObject>(GraphcialObject.class, this, BpmnPackage.BUSINESS_CONCEPTS__TOPIC_CHILD, BpmnPackage.GRAPHCIAL_OBJECT__BUSINESSCONCEPTS_PARENT);
		}
		return topicChild;
	}
	...
	public EList<GraphcialObject> getTopic() {
		if (topic == null) {
			topic = new EObjectWithInverseResolvingEList.ManyInverse<GraphcialObject>(GraphcialObject.class, this, BpmnPackage.BUSINESS_CONCEPTS__TOPIC, BpmnPackage.GRAPHCIAL_OBJECT__TYPE);
		}
		return topic;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case BpmnPackage.BUSINESS_CONCEPTS__TOPIC_CHILD:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTopicChild()).basicAdd(otherEnd, msgs);
			case BpmnPackage.BUSINESS_CONCEPTS__TOPIC:
